    ...
    render() {
        return (
            <View style={styles.root}>
                ...
                <Text style={styles.explain}>・画面の下のエントリーボタンをぽちっ</Text>
                <Text style={styles.subtitle}>2 {C.ArenaStateString[C.ArenaState.CONFIRM]}</Text>
                <Text style={styles.explain}>・画面の下がマイクボタンに変わっているはず</Text>
                <Text style={styles.explain}>・ミュートを解除、マイクチェック・ワン・ツー</Text>
                <Text style={styles.subtitle}>3 {C.ArenaStateString[C.ArenaState.CHECK]}</Text>
                <Text style={styles.explain}>・規約をしっかり読んで、同意ボタンをぽちっ</Text>
                <Text style={styles.explain}>・演じる箇所までは自動でスクロール</Text>
                <Text style={styles.explain}>・お話、キャラ、漢字をチェック</Text>
                <Text style={styles.subtitle}>4 {C.ArenaStateString[C.ArenaState.CHECK]}</Text>
